...
/**
 * REST controller for managing {@link com.fininfo.bazarshop.domain.CodePostaux}.
 */
@RestController
@RequestMapping("/api")
public class CodePostauxResource {
    ...
    public ResponseEntity<CodePostauxDTO> updateCodePostaux(@RequestBody CodePostauxDTO codePostauxDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, codePostauxDTO.getId().toString()))
            .body(result);
    }
