...
/**
 * REST controller for managing {@link com.fininfo.bazarshop.domain.CommandeLignes}.
 */
@RestController
@RequestMapping("/api")
public class CommandeLignesResource {
    ...
    public ResponseEntity<CommandeLignesDTO> updateCommandeLignes(@RequestBody CommandeLignesDTO commandeLignesDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, commandeLignesDTO.getId().toString()))
            .body(result);
    }
