...
/**
 * REST controller for managing {@link com.fininfo.bazarshop.domain.SousCategorie}.
 */
@RestController
@RequestMapping("/api")
public class SousCategorieResource {
    ...
    public ResponseEntity<SousCategorieDTO> updateSousCategorie(@Valid @RequestBody SousCategorieDTO sousCategorieDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, sousCategorieDTO.getId().toString()))
            .body(result);
    }
