...
import com.fininfo.bazarshop.service.MouvementStockService;
...
/**
 * REST controller for managing {@link com.fininfo.bazarshop.domain.MouvementStock}.
 */
@RestController
@RequestMapping("/api")
public class MouvementStockResource {
    ...
    public ResponseEntity<MouvementStockDTO> updateMouvementStock(@RequestBody MouvementStockDTO mouvementStockDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, mouvementStockDTO.getId().toString()))
            .body(result);
    }
