...
import com.fininfo.bazarshop.repository.ProdEnumerationRepository;
import com.fininfo.bazarshop.repository.search.ProdEnumerationSearchRepository;
...
/**
 * REST controller for managing {@link com.fininfo.bazarshop.domain.ProdEnumeration}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class ProdEnumerationResource {
    ...
    public ResponseEntity<ProdEnumeration> updateProdEnumeration(@RequestBody ProdEnumeration prodEnumeration) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, prodEnumeration.getId().toString()))
            .body(result);
    }
