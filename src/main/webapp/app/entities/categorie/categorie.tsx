            ...
            <tbody>
              {categorieList.map((categorie, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{categorie.etat ? 'true' : 'false'}</td>
                  <td>
                    {categorie.image ? (
                      <div>
                        <a onClick={openFile(categorie.imageContentType, categorie.image)}>
                          <img src={`data:${categorie.imageContentType};base64,${categorie.image}`} style={{ maxHeight: '30px' }} />
                          &nbsp;
                        </a>
                        <span>
                  ...
                  <td>
                    <TextFormat type="date" value={categorie.creeLe} format={APP_LOCAL_DATE_FORMAT} />
                  </td>
                  <td>{categorie.creePar}</td>
                  <td>
                    <TextFormat type="date" value={categorie.modifieLe} format={APP_LOCAL_DATE_FORMAT} />
                  </td>
                  <td>{categorie.modifiePar}</td>
