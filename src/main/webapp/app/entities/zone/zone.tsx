    ...
    <div>
      ...
      <div className="table-responsive">
        {zoneList && zoneList.length > 0 ? (
            ...
            <tbody>
              {zoneList.map((zone, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{zone.nom}</td>
                  <td>
                    <TextFormat type="date" value={zone.creeLe} format={APP_LOCAL_DATE_FORMAT} />
                  </td>
                  <td>{zone.creePar}</td>
                  <td>
                    <TextFormat type="date" value={zone.modifieLe} format={APP_LOCAL_DATE_FORMAT} />
                  </td>
          ...
          !loading && <div className="alert alert-warning">No Zones found</div>
        )}
      </div>
    </div>
  );
