...
import com.fininfo.bazarshop.repository.CodePostauxRepository;
import com.fininfo.bazarshop.repository.search.CodePostauxSearchRepository;
import com.fininfo.bazarshop.service.CodePostauxService;
import com.fininfo.bazarshop.service.dto.CodePostauxDTO;
import com.fininfo.bazarshop.service.mapper.CodePostauxMapper;
...
public class CodePostauxResourceIT {
     ...
     *
     * @see com.fininfo.bazarshop.repository.search.CodePostauxSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createCodePostaux() throws Exception {
        ...
        assertThat(testCodePostaux.getZone()).isEqualTo(DEFAULT_ZONE);
    ...
    public void updateCodePostaux() throws Exception {
        ...
        assertThat(testCodePostaux.getZone()).isEqualTo(UPDATED_ZONE);
